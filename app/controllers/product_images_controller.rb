class ProductImagesController < ApplicationController
  ...
  def new
    @product_image = ProductImages.new
  end
  ...
  def create
    @product_image = ProductImages.new(product_image_params)
  ...
  def update
    respond_to do |format|
      if @product_images.update(product_images_params)
        format.html { redirect_to @product_images.product, notice: 'Product image was successfully updated.' }
        format.json { render :show, status: :ok, location: @product_images }
      else
        format.html { render :edit }
        format.json { render json: @product_images.errors, status: :unprocessable_entity }
      end
    end
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to @product_images.product, notice: 'Product image was successfully destroyed.' }
